...
napi_value NotificationInit(napi_env env, napi_value exports)
{
    ...
    napi_property_descriptor desc[] = {
        ...
        DECLARE_NAPI_FUNCTION("setSlotAsBundle", SetSlotAsBundle),
        DECLARE_NAPI_FUNCTION("getSlot", GetSlot),
        DECLARE_NAPI_FUNCTION("getSlotNumAsBundle", GetSlotNumAsBundle),
        DECLARE_NAPI_FUNCTION("getSlots", GetSlots),
        DECLARE_NAPI_FUNCTION("getSlotsAsBundle", GetSlotsAsBundle),
